...
Urmatoarele lucruri de implementat:

-filtru pentru a nu hardcoda interfata de unde dorim sa preluam trafic (linia 199).
-exportarea logurilor in format CSV.

Pentru pornirea aplicatiei trebuiesc instalate modulele necesare si schimbarea interfetei in linia 199.
